...
public class Vector {
     ...
     * @return
     */
    public static double VectorProduct(Vector a, Vector b){
     ...
     * @param n число
     */
    public static void MultiplyingAVectorByANumber(Vector a, double n){
        Vector c = new Vector();
        c.setX1(a.getX1()*n);
        c.setX2(a.getX2()*n);
        c.setY1(a.getY1()*n);
    ...
    public static void main(String[] args) {
        Vector a = new Vector(2,1,1,2);
        Vector b = new Vector(5,5,9,3);
        System.out.println(VectorProduct(a,b));
        System.out.println(ScalarProduct(a,b));
        System.out.println(VectorLength(a));
        MultiplyingAVectorByANumber(a,3);
        VectorSum(a,b);
